...
class Category
{
     ...
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Article", mappedBy="category", cascade={"persist"})
     */
    private $articles;

    /**
     * @ORM\ManyToMany(targetEntity="AppBundle\Entity\User", mappedBy="categoryLikes")
